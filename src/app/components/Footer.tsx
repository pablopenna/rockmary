        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#how-we-help" className="hover:text-white transition">How We Help</a></li>
              <li><a href="#principles" className="hover:text-white transition">Our Principles</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">
              <a href="mailto:contact@rockmary.com" className="hover:text-white transition">
                contact@rockmary.com
              </a>
            </p>
            <p className="text-gray-400 text-sm">Available for new projects and team augmentation</p>
          </div>
        </div>
